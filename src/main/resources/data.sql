...
(1, 1, '8010 990807', '2014-10-01'),
(2, 1, '8009 991817', '2008-11-15'),
(3, 2, '8007 545796', '2000-09-01'),
(4, 1, '8811 450101', '1999-12-12'),
(5, 4, '0011 010101', '1985-05-09'),
(6, 3, '9999 000000', '1989-06-06'),
...
(1, 1, 12, 1, 'Артем', 'Андреев', 'Петрович', 'Генеральный директор', '+7 917 345 12 11', true, 0),
(2, 1, 11, 1, 'Снежана', 'Семенова', 'Денисовна', 'Заведующая хозяйством', '+7 987 100 01 11', true, 0),
(3, 2, 10, 1, 'Владислав', 'Ильмурзин', 'Владимирович', 'Водитель-экспедитор', '+7 909 350 88 78', true, 0),
(4, 2, 9, 2, 'Сергей', 'Семенов', 'Браниславович', 'Продавец', '+7 911 123 45 67', true, 0),
(5, 3, 8, 1, 'Остап', 'Ибрагимович', 'Наилевич', 'Начальник отдела продаж', '+7 905 905 43 34', true, 0),
(6, 3, 7, 3, 'Андрей', 'Ильин', 'Сергеевич', 'Кладовщик', '+7 913 139 13 13', true, 0),
(7, 4, 6, 1, 'Максим', 'Шерстнев', 'Николаевич', 'Грузчик', '+7 987 595 13 13', true, 0),
(8, 4, 5, 2, 'Игорь', 'Комиссаров', 'Олегович', 'Программист 1С', '+7 989 567 76 43', true, 0),
(9, 5, 4, 1, 'Ильнур', 'Акутян', 'Ильдарович', 'Маркетолог', '+7 935 567 76 43', true, 0),
(10,5, 3, 1, 'Альберт', 'Миннуллин', 'Рафисович', 'Каменщик', '+7 927 000 77 43', true, 0),
(11,6, 2, 3, 'Эдуард', 'Шарафутдинов', 'Геннадьевич', 'Логист', '+7 927 001 37 43', true, 0),
(12,6, 1, 1, 'Барух', 'Сагодурский', 'Барухович', 'Клиентский менеджер', '+7 917 101 32 49', true, 0);